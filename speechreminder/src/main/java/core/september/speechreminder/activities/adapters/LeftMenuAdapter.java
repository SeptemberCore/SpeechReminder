 ...
 */
public class EventModelAdapter extends ArrayAdapter<Integer> {
    private Activity context;
    private  Integer[] positions;
    private ListItemFragment.UpdateListener mListener;


    public EventModelAdapter(Activity context, int layout, Integer[] positions) {
        super(context, R.layout.left_drawer_row, events);
